...
router.post(
  ...
  [
    auth,
    [
      check('seniority', 'Seniority field is required')
        .not()
        .isEmpty(),
      check('term', 'Term field is required')
        .not()
        .isEmpty(),
      check('position', 'Position field is required')
        .not()
        .isEmpty(),
      ...
      check('contactName', 'Contact name is required')
        .not()
        .isEmpty(),
      check('contactInfo', 'Contact information is required')
        .not()
        .isEmpty()
    ]
  ],
